	...
	<form action="ManagementMCQDesigner/${mcq.id}"
		...
		<div class="row form-group">
			<div class="col-lg-6 col-md-6 form-group">
				<label for="inputBody">Body</label> <input type="text"
					class="form-control" name="body" placeholder="presentation QCM"
					value="${mcq.body}">

			</div>
			<div class="col-lg-6 col-md-6 form-group">
				<label for="inputTheme">Themexxxx</label> <input type="text"
					class="form-control" name="themexxxxx" id="inputTheme"
					placeholder="Theme du QCM" value="${mcq.theme}">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-lg-6 col-md-6 form-group">
				<label for="inputUsername">xxxxxxxxxxx</label> <input type="text"
					class="form-control" id="inputUsername" placeholder="Admin">
	</div>
			<div class="col-lg-6 col-md-6 form-group">
				<label for="inputEmail">xxxxxxxxxxxxxx</label> <input type="text"
...
<!-- debut de la zone du tableau -->
<div class="templatemo-content-widget white-bg">
	<form action="index.html" class="templatemo-login-form" method="post"
	...
	<div class="templatemo-content-widget no-padding">
		<div class="panel panel-default table-responsive">
			<table
				...
				<thead>
					<tr>
						<td width="30px"><a href=""
							class="white-text templatemo-sort-by"># <span class="caret"></span></a></td>
						<td><a href="" class="white-text templatemo-sort-by">body
								<span class="caret"></span>
						</a></td>
						<td width="100px"><a href=""
							class="white-text templatemo-sort-by">theme <span
