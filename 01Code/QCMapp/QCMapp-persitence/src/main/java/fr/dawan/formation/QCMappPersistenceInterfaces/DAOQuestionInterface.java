...
public interface DAOQuestionInterface {
	...
	public ArrayList<Question> searchById (int idQuestion);
	public ArrayList<Question> searchByTheme (Theme theme);
	...
	public ArrayList<Question> searchByAuthor (int idAuthor);
}
